    ...
    return (
        ...
        <section className="bg-primary pb-10">
            <div className="container px-6 py-10 mx-auto">
                <div className='mt-4 text-gray-500 xl:mt-6 dark:text-gray-300 text-center'>
                ...
                <div className="rounded-lg bg-white p-6 shadow-md bg-neutral-700 space-y-3 border-2 border-neutral">
                        ...
                        <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Conéctate Directamente</h1>
                    ...
                    <div className="rounded-lg bg-white p-6 shadow-md bg-neutral-700 space-y-3 border-2 border-neutral">
                        ...
                        <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Explora y Encuentra</h1>
                    ...
                    <div className="rounded-lg bg-white p-6 shadow-md bg-neutral-700 space-y-3 border-2 border-neutral">
                        ...
                        <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Información Clara y al día</h1>
